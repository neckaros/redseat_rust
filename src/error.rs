...
pub enum Error {
    ...
    #[from]
    RsIdsError(
        #[serde_as(as = "DisplayFromStr")] rs_plugin_common_interfaces::domain::rs_ids::RsIdsError,
    ),
}
    ...
    pub fn client_status_and_error(&self) -> (StatusCode, ClientError) {
        ...
        match self {
            ...
            Self::UnavailableForCryptedLibraries => (
                ...
                ClientError::NOT_FOR_CRYPTED_LIBRARY,
            ),

            Self::LoginFail => (StatusCode::FORBIDDEN, ClientError::LOGIN_FAIL),
            Self::Model(err) => err.client_status_and_error(),
            // -- Auth.
            Self::ServerAlreadyRegistered => (
                StatusCode::FORBIDDEN,
                ClientError::SERVER_ALREADY_REGISTERED,
            ),
