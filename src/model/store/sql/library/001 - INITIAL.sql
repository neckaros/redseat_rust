...
CREATE TABLE episodes (serie_ref TEXT, name TEXT, season INTEGER, number INTEGER, abs INTEGER, overview TEXT, airdate INTEGER,  duration INTEGER, type TEXT, alt TEXT, params TEXT, imdb TEXT, slug TEXT, tmdb INTEGER, trakt INTEGER, tvdb INTEGER, otherids TEXT, modified INTEGER, created INTEGER, added INTEGER, imdb_rating REAL, imdb_votes INTEGER, trakt_rating REAL, trakt_votes INTEGER, PRIMARY KEY (serie_ref, season, number)) WITHOUT ROWID;
...
CREATE TABLE medias (id TEXT PRIMARY KEY, source TEXT, name TEXT, size INTEGER, type TEXT, mimetype TEXT, md5 TEXT, modified INTEGER, created INTEGER, added INTEGER, starred INTEGER, width INTEGER, height INTEGER, duration INTEGER, thumb TEXT, thumbv INTEGER, iv TEXT, thumbsize INTEGER, long REAL, lat REAL, model TEXT, pages INTEGER, params TEXT, origin TEXT, progress INTEGER, movie TEXT, acodecs TEXT, achan TEXT, vcodecs TEXT, fps INTEGER, bitrate INTEGER, colorSpace TEXT, focal INTEGER, iso INTEGER, sspeed TEXT, orientation INTEGER, phash TEXT, thumbhash TEXT, description TEXT, lang TEXT, uploader TEXT, uploadkey TEXT, aitag INTEGER DEFAULT "0" NOT NULL CHECK (aitag IN (0, 1)), aiassign INTEGER DEFAULT "0" NOT NULL CHECK (aitag IN (0, 1))) WITHOUT ROWID;
...
CREATE TABLE series (id TEXT PRIMARY KEY, name TEXT, year INTEGER, type TEXT, alt TEXT, params TEXT, poster TEXT, imdb TEXT, slug TEXT, tmdb INTEGER, trakt INTEGER, tvdb INTEGER, otherids TEXT, created INTEGER, lang TEXT, original TEXT, modified INTEGER, added INTEGER, imdb_rating REAL, imdb_votes INTEGER, trailer TEXT, maxCreated INTEGER, trakt_rating REAL, trakt_votes INTEGER) WITHOUT ROWID;
