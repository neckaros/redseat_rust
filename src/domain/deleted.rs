...
impl RsDeleted {
    ...
    pub fn movie(id: String) -> Self {
        Self {
            id,
            date: now().timestamp_millis(),
            kind: ElementType::Movie,
        }
    }
    pub fn book(id: String) -> Self {
        Self {
            id,
            date: now().timestamp_millis(),
            kind: ElementType::Book,
        }
    }
}
